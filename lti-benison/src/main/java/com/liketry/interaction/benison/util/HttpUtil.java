...
public class HttpUtil {
	...
	public static String getRequest(String url) {
		try {
			...
			String result = EntityUtils.toString(entity, DEFAULT_CHARSET_NAME);
			return result;
		} catch (Exception e) {
			log.error("http req error", e);
			return null;
		}
	}
	...
	public static String postRequest(String url, List<NameValuePair> params) {
		try {
			...
			if(params!=null){
				post.setEntity(new UrlEncodedFormEntity(params, DEFAULT_CHARSET_NAME));
			}
			...
			log.error("http req error=" + url, e);
			return null;
		}
	}
	...
	public static String sendPost(String url, String cnt) {
		...
		try {
			...
			log.error("http get throw Exception" + e.toString());
		} finally {
			httpPost.abort();
		}
		return result;
	...
	public static String sendPut(String url, String cnt) {
		String result = null;
	...
	public static Map<String, String> paraseURI(String uri) {
		try {
			...
			List<NameValuePair> parse = URLEncodedUtils.parse(new URI(uri), DEFAULT_CHARSET_NAME);
			for (NameValuePair nameValuePair : parse) {
				map.put(nameValuePair.getName(), nameValuePair.getValue());
			}
			return map;
		} catch (Exception e) {
			log.error("parase uri error", e);
		}
		return null;
	}
