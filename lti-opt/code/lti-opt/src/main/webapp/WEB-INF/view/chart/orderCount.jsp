...
<div>
	...
	<div data-options="region:'center',border:false" style="overflow: hidden;height:390px;" >
		<table id="dataTable" title="订单汇总列表" height="100%"></table>
	</div>
</div>
...
function getDataForHighcharts() {  
    ...
    $.ajax({  
        ...
        type: 'GET',  
        dataType : "json",  
		url:'${rootPath}/orderTotal/getOrderCountForPic?nameBy=order_id',//请求的路径  
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    if(childrenList.length >0){
                    	 ...
                    	 for(var j=0;j<childrenList.length;j++){
                    		 var type = {};
                    		 type.y=childrenList[j].total;
                    		 type.name = childrenList[j].typeName; 
                    		 list3.push(type);
                    	 }
                    }
                    data2.data = list3;
