...
<!-- 		<div class="fitem"> -->
<!-- 	    	<label>屏幕ID:</label> -->
<!-- 	        <input name="screenId" class="easyui-textbox" style="width:240px" required="required"> -->
<!-- 		</div> -->
		<div class="fitem">
	    	<label>屏幕:</label>
	        <input name="screenId" id="screenId" type="hidden">
	        <input name="screenName" id="screenName" class="easyui-textbox" style="width:240px" required="required">
		...
		<div class="fitem">
			<label>图片URL:</label>
			<input class="easyui-filebox" name="commodityImg" id="commodityImg" data-options="prompt:'请选择一个图片'" data-options="required:true">
		</div>
		<div class="fitem">
	    	<label>价格:</label>
		...
		<div class="fitem">
	    	<label>开始日期:</label>
	        <input name="startDate" class="easyui-datebox"  style="width:120px" required="required">
		</div>
		<div class="fitem">
	    	<label>结束日期:</label>
	        <input name="endDate" class="easyui-datebox"  style="width:120px" required="required">
		</div>
		<div class="fitem">
	    	<label>时间频率:</label>
	        <select class="easyui-combobox" name="timeFrame" style="width:80px" panelHeight="130px" required="required">
		...
		<div class="fitem">
	    	<label>下架时间:</label>
	        <input name="shelfTime" class="easyui-timespinner"  style="width:80px" required="required">
		</div>
		<div class="fitem">
	    	<label>计划售卖数量:</label>
	        <input name="planNumber" class="easyui-numberbox"  precision="0" validType="length[0,5]" 
	        		style="width:80px" required="required" value="20"></input> 个
		</div>
		<div class="fitem">
	    	<label>单次播放时间:</label>
	        <input name="singleTime" class="easyui-numberbox"  precision="0" validType="length[0,5]" style="width:80px" required="required" value="15"> 秒
		</div>
		<div class="fitem">
	    	<label>播放次数:</label>
	        <input name="playTimes" class="easyui-numberbox"  precision="0" validType="length[0,5]" style="width:80px" required="required" value="12">
	        </input> 次
		</div>
		<div class="fitem">
	    	<label>描述:</label>
