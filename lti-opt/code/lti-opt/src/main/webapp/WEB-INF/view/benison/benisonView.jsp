...
<div>
	<form id="dataForm">
			...
			<div class="fitem">
		    	<label>祝福语内容:</label>
		        <input name="benisonContent" class="easyui-textbox" data-options="multiline:true" style="width:230px;height:100px" disabled>
			</div>
			<div class="fitem">
		    	<label>规则内容:</label>
		        <input name="ruleContent" class="easyui-textbox" data-options="multiline:true" style="width:230px;height:100px" disabled>
			</div>
