...
<div>
	<form id="dataForm">
		<div class="fitem">
	    	<label>名称:</label>
	        <input name="couponName" class="easyui-textbox" validType="length[0,50]" data-options="required:true">
		</div>
		<div class="fitem">
		    <label>是否有效:</label>
			<select class="easyui-combobox" name="validType"  style="width:80px" panelHeight="80px"  data-options="required:true">
		...
		<div class="fitem">
		    <label>是否发布:</label>
			<select class="easyui-combobox" name="publishType" style="width:80px" panelHeight="80px"  data-options="required:true">
		...
		<div class="fitem">
		    <label>类型:</label>
			<select class="easyui-combobox" name="couponType" id ="couponType" style="width:80px" panelHeight="80px"  data-options="required:true">
 			</select>
		</div>
		...
		<div class="fitem">
	    	<label>屏幕:</label>
	        <input name="screenIds" class="easyui-textbox" >
		</div>
		<div class="fitem">
	    	<label>商品:</label>
	        <input name="commodityIds" class="easyui-textbox" >
		</div>
		<div class="fitem">
	    	<label>祝福类型:</label>
	        <input name="benisonTypeIds" class="easyui-textbox" >
		</div>
	</form>
