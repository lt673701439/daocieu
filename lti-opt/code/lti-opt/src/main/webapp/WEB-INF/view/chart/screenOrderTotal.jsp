...
<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <div data-options="region:'center',border:false" style="overflow: hidden;">
		<table id="dataTable" title="屏幕订单汇总列表" height="100%"></table>
	</div>
</div>
	...
	$.get('${rootPath}/screenOrderTotal/getColumns', {screenId:screenId},function(data){
    	...
    	if(data != null){
    		...
    		$('#dataTable').datagrid({
    			...
    			loadMsg: '数据加载中，请稍后...',
    			queryParams:{nameBy:"order_id",screenId:screenId},
    			method : 'post',		
...
function getDataForHighcharts() {  
    ...
    $.ajax({  
        ...
        type: 'GET',  
        dataType : "json",
		url:'${rootPath}/screenOrderTotal/getOrderCountForPic?nameBy=order_id',//请求的路径  
		beforeSend: function () {
