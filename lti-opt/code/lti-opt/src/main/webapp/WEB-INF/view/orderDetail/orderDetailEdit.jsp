...
<div class="easyui-panel" title="XX详细信息编辑" style="width:600px">
	<form id="dataForm">
			<div class="fitem">
		        ...
		        <input name="detailId" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>orderId:</label>
			...
			<div class="fitem">
		        ...
		        <input name="commodityId" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>commodityCode:</label>
		        <input name="commodityCode" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>commodityName:</label>
		        <input name="commodityName" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>commodityDescription:</label>
		        <input name="commodityDescription" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>commodityPrice:</label>
		        <input name="commodityPrice" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>playDate:</label>
		        <input name="playDate" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>timeStart:</label>
		        <input name="timeStart" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>timeEnd:</label>
		        <input name="timeEnd" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>singleTime:</label>
		        <input name="singleTime" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>playTimes:</label>
		        <input name="playTimes" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>skuId:</label>
			...
			<div class="fitem">
		    	<label>skuName:</label>
		        <input name="skuName" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>skuDescription:</label>
		        <input name="skuDescription" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>skuPrice:</label>
		        <input name="skuPrice" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
...
jQuery(function(){ 
	...
	if (rowId != null && rowId != "" && rowId!=0){
		var url='${rootPath}/orderDetail/getOne?rowId=' + rowId;
...
function saveOrUpdate()
{
	...
	{		
		...
		$.post("${rootPath}/orderDetail/save",$("#dataForm").serializeArray(),
		function(data)
		{			
