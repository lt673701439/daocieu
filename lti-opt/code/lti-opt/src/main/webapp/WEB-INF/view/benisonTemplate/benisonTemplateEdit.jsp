...
<div>
	<form id="dataForm" enctype="multipart/form-data" accept="image/gif,image/jpeg,image/jpg,image/png" method="post">
		    ...
		    <div class="fitem">
		    	<label>描边偏移X:</label>
		        <input name="strokeX" class="easyui-numberbox"  style="width: 100px;" validType="length[0,10]">
			</div>
			<div class="fitem">
		    	<label>描边偏移Y:</label>
		        <input name="strokeY" class="easyui-numberbox" style="width: 100px;" validType="length[0,10]">
			</div>
			<div class="fitem">
		    	<label>描边透明度:</label>
		        <input name="strokeAlpha" class="easyui-numberbox" precision="1" groupSeparator="," decimalSeparator="."  style="width: 100px;" validType="length[0,3]">
			</div>
			</form>
