...
<div class="easyui-panel" title="XX信息管理" style="width:805px">
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				...
				<div class="fitem">
		        	<label>stockId:</label>
		        	<input name="stockId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>orderId:</label>
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							...
							{field:'stockId',title:'stockId',width:80},
							{field:'orderId',title:'orderId',width:80},
							{field:'startTime',title:'startTime',width:80},
							{field:'endTime',title:'endTime',width:80},
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/stockDetail/list';
   ...
   function editrow(){    	
       ...
       if (row){
       	url = '${rootPath}/stockDetail/edit?rowId='+ row.rowId;
		openWin(url);
       }
       else
       {
   ...
   function delerow(){
       ...
       if (row){
           $.messager.confirm('提示','确定要删除行记录吗？',function(r){
               if (r){
                   $.post('${rootPath}/stockDetail/del',{rowId:row.rowId},function(data){
