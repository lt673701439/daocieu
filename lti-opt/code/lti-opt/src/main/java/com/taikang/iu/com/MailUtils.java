...
import com.taikang.udp.framework.core.properties.PropertiesUtils;
...
public class MailUtils {
	...
	protected static PropertiesHandler pro = PropertiesHandlerFactory.getPropertiesHelper(PropertiesFile.FRAMEWORK);
...
//    }
    public void setAddress(String from,String user,String pwd,String subject) {
        this.from = from;
        this.user = user;
        this.pwd = pwd;
        this.subject = subject;
...
//            contentPart.setText();
            contentPart.setContent(messageContent, "text/html;charset=UTF-8");
